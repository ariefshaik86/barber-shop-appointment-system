...
@REM To enable internal ECHO statements to be visible in the batch console output,
@REM set MAVEN_BATCH_ECHO to 'ON' (the default).  To silence them, set to 'OFF'.
...
@REM To isolate the variables internal to this script from other environment
@REM variables, these variables are set temporarily here and restored later.
